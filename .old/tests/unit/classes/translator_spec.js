...
describe("Translator", function() {
	...
	describe("translate", function() {
		...
		it("should return custom module translation", function(done) {
			const dom = new JSDOM(`<script src="${path.join(__dirname, "..", "..", "..", "src", "translator.js")}">`, { runScripts: "dangerously",
				resources: "usable" });
	...
	describe("load", function() {
		...
		it("should load translations", function(done) {
			const dom = new JSDOM(`<script>var Log = {log: function(){}};</script><script src="${path.join(__dirname, "..", "..", "..", "src", "translator.js")}">`, { runScripts: "dangerously",
				resources: "usable" });
			dom.window.onload = function() {
				const {Translator} = dom.window;
	...
	describe("loadCoreTranslations", function() {
		it("should load core translations and fallback", function(done) {
			const dom = new JSDOM(`<script>var translations = {en: "http://localhost:3000/translations/en.json"}; var Log = {log: function(){}};</script>\
					<script src="${path.join(__dirname, "..", "..", "..", "src", "translator.js")}">`, { runScripts: "dangerously",
				resources: "usable" });
			dom.window.onload = function() {
				const {Translator} = dom.window;
